<header id="page-topbar">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ url('/') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ url ('/assets/images/bumdesma-mini.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url ('/assets/images/bumdesma.png') }}" alt="" height="30">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        <button type="button" class="btn header-item waves-effect show" data-bs-toggle="dropdown" aria-haspopup="false" aria-expanded="true">
            <span key="t-megamenu">{{ date('d-m-Y H:i:s'); }}</span>
        </button>
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="{{ url('/user/profile-detail') }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('translation.Profile')</span></a>
